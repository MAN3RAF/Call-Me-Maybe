*This project has been created as part of the 42 curriculum by lsebar, ldevelle, pcamaren, crfernan.*
...
**AI Usage** : AI tools were utilized to reduce repetitive tasks, explaining the mechanics of Large Language Models (LLMs) to ensure deterministic outputs by applying constrained decoding techniques on raw model generations.
